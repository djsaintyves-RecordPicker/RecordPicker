...
COPY = {
    ...
    "es-es": ("70 códigos Pro · 14 días · empieza el 9 de agosto", "Tres elecciones. Una favorita. Gana Pro para siempre.", "Participa en el 3 Picks Challenge del 9 al 22 de agosto de 2026 y pon en juego tu propia colección.", "Añade al menos cinco discos", "Haz un Random Pick, un Today’s Pick y un Mood Pick", "Comparte tu favorito en Instagram con #RecordPickerChallenge", "Sigue el reto en Instagram", "No se requiere compra, puntuación ni reseña en el App Store. Los detalles de participación y selección se publican en Instagram."),
    "es-mx": ("70 códigos Pro · 14 días · comienza el 9 de agosto", "Tres elecciones. Una favorita. Gana Pro para siempre.", "Participa en el 3 Picks Challenge del 9 al 22 de agosto de 2026 y pon en juego tu propia colección.", "Agrega al menos cinco discos", "Haz un Random Pick, un Today’s Pick y un Mood Pick", "Comparte tu favorito en Instagram con #RecordPickerChallenge", "Sigue el reto en Instagram", "No se requiere compra, calificación ni reseña en el App Store. Los detalles de participación y selección se publican en Instagram."),
    ...
    "hi": ("70 Pro कोड · 14 दिन · 9 अगस्त से", "तीन चुनाव। एक पसंदीदा। हमेशा के लिए Pro जीतें।", "9 से 22 अगस्त 2026 तक 3 Picks Challenge में अपने रिकॉर्ड संग्रह के साथ हिस्सा लें।", "कम से कम पाँच रिकॉर्ड जोड़ें", "एक Random Pick, एक Today’s Pick और एक Mood Pick करें", "अपना पसंदीदा चुनाव Instagram पर #RecordPickerChallenge के साथ साझा करें", "Instagram पर चैलेंज देखें", "खरीदारी, App Store रेटिंग या समीक्षा आवश्यक नहीं है। पात्रता और चयन की जानकारी Instagram पर प्रकाशित की जाती है।"),
    ...
    "pl": ("70 kodów Pro · 14 dni · start 9 sierpnia", "Trzy wybory. Jeden ulubiony. Wygraj Pro na zawsze.", "Weź udział w 3 Picks Challenge od 9 do 22 sierpnia 2026 ze swoją kolekcją płyt.", "Dodaj co najmniej pięć płyt", "Wykonaj po jednym Random Pick, Today’s Pick i Mood Pick", "Udostępnij ulubiony wybór na Instagramie z #RecordPickerChallenge", "Obserwuj wyzwanie na Instagramie", "Zakup, ocena ani recenzja w App Store nie są wymagane. Zasady udziału i wyboru są publikowane na Instagramie."),
    ...
    "ru": ("70 кодов Pro · 14 дней · старт 9 августа", "Три выбора. Один любимый. Выиграйте Pro навсегда.", "Участвуйте в 3 Picks Challenge с 9 по 22 августа 2026 года со своей коллекцией пластинок.", "Добавьте не менее пяти пластинок", "Сделайте по одному Random Pick, Today’s Pick и Mood Pick", "Поделитесь любимым выбором в Instagram с #RecordPickerChallenge", "Следить за конкурсом в Instagram", "Покупка, оценка или отзыв в App Store не требуются. Условия участия и выбора публикуются в Instagram."),
    ...
    "vi": ("70 mã Pro · 14 ngày · bắt đầu 9 tháng 8", "Ba lượt chọn. Một yêu thích. Nhận Pro trọn đời.", "Tham gia 3 Picks Challenge từ ngày 9 đến 22 tháng 8 năm 2026 bằng chính bộ sưu tập của bạn.", "Thêm ít nhất năm đĩa", "Thực hiện một Random Pick, một Today’s Pick và một Mood Pick", "Chia sẻ lựa chọn yêu thích trên Instagram với #RecordPickerChallenge", "Theo dõi thử thách trên Instagram", "Không cần mua, xếp hạng hay đánh giá trên App Store. Điều kiện và cách lựa chọn được công bố trên Instagram."),
