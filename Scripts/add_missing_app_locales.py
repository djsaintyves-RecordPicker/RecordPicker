...
DATA = {
    "th": {
        ...
        "available": "พร้อมให้ดาวน์โหลดแล้ว", "soon": "เร็ว ๆ นี้ · 2.0",
        "home_title": "เลือกแผ่นที่ใช่ - Record Picker",
        "home_desc": "จัดหมวดหมู่แผ่นเสียงไวนิลและ CD แล้วเลือกแผ่นที่จะฟังด้วยการสุ่มที่ปรับแต่งได้ Mood Pick และแผ่นประจำวันบนอุปกรณ์ Apple",
        "tagline": "เลือกแผ่นที่ใช่",
        "intro": "จัดหมวดหมู่แผ่นเสียงไวนิลและ CD แล้วเลือกแผ่นถัดไปด้วยการสุ่มที่ปรับแต่งได้ Mood Pick หรือแผ่นประจำวัน คอลเลกชันของคุณยังคงเป็นส่วนตัว ซิงค์ผ่าน iCloud ระหว่าง iPhone, iPad และ Mac ได้ และใช้งานบน Apple Watch ได้ด้วย",
        "today": "แผ่นประจำวัน",
    ...
    "vi": {
        ...
        "available": "Hiện đã có", "soon": "Sắp ra mắt · 2.0",
        "home_title": "Phát đúng đĩa nhạc - Record Picker",
        "home_desc": "Lập danh mục đĩa than và CD, rồi chọn đĩa để nghe bằng lựa chọn ngẫu nhiên có thể tùy chỉnh, Mood Pick và Đĩa nhạc hôm nay trên các thiết bị Apple.",
        "tagline": "Phát đúng đĩa nhạc",
        "intro": "Lập danh mục đĩa than và CD, rồi chọn đĩa tiếp theo bằng lựa chọn ngẫu nhiên có thể tùy chỉnh, Mood Pick hoặc Đĩa nhạc hôm nay. Bộ sưu tập luôn riêng tư, có thể đồng bộ qua iCloud giữa iPhone, iPad và Mac, đồng thời cũng có trên Apple Watch.",
...
def main_markup(kind: str, d: dict[str, object]) -> str:
    ...
    if kind == "index.html":
        ...
        return (f'<main id="main-content"><section class="hero"><div class="hero-copy"><h1>Record Picker</h1><h2>{d["tagline"]}</h2><p>{d["intro"]}</p><div class="cta-row"><a class="button primary" href="https://apps.apple.com/{d["store"]}/app/recordpicker/id6780422305">App Store</a><a class="button glass" href="mac-app/">{d["nav"][6]}</a></div></div><div class="hero-showcase v19-hero-showcase">{mac}</div></section>'
                ...
                f'<section class="section next-release" data-release-version="2.0"><div class="section-head"><p class="kicker">{soon}</p><h2>Record Picker 2.0</h2></div></section>'
